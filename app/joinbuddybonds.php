...
<head>
	...
	<link rel="stylesheet" href="http://fonts.googleapis.com/css?family=Lobster+Two|Roboto|Open+Sans|Fira+Code|Nunito">
...
<body>
	...
	<main class="text-center">
		<h4 class="mt-5 mb-3">JOIN BUDDYBONDS DEVELOPMENT TEAM</h4>
		<div class="msg">
			Have some programming experience??<br>Want to join me in an amazing coding environment??<br>Or just want to
			give a review about buddyBonds??<br> If yes , join hands with me and lets together make buddyBonds more
			better and more secure.<br>
			Connect with me using gmail : <b><a href="mailto:connect@buddybonds.com" target="_blank"
					data-toggle="tooltip"
					title="Clicking will open your mail provider link">connect@buddybonds.com</a></b>
		</div>
	</main>
